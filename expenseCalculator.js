        ...
        *************************************************************************************************/
         ...
         function calculatePercentages() {
                  ...
                  *******************************************************************************************************/              
                  ...
                  var householdPct; //house percent
                  var transportationPct; // trans percent
                  var miscellaneousPct; // misc percent
                  ...
                  *******************************************************************************************************/  
                  ...
                  document.getElementById("shelterPercentage").innerHTML = "% for shelter:      " + shelterPct.toFixed(1);  
                  document.getElementById("foodPercentage").innerHTML = "% for food:      " + foodPct.toFixed(1);
                  document.getElementById("householdPercentage").innerHTML = "% for household:" + householdPct.toFixed(1);
                  document.getElementById("transportationPercentage").innerHTML = "% for transportation:" + transportationPct.toFixed(1);
                  document.getElementById("miscellaneousPercentage").innerHTML = "% for miscellaneous:" + miscellaneousPct.toFixed(1);
